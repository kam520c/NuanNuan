...
/**
 * 天气数据解释类.从网络获得是是一个XML文件.所以我们需要解释它才可以用.解释后的数据 存放在WeatherCondition类里.
 * 
 * @author Hong
 * 
 */
public class WeatherParser {
	 ...
	 * 解释动作.
	 */
	public boolean parse(InputStream is, int day) throws IOException,
		...
		while (eventType != XmlPullParser.END_DOCUMENT) {
			...
			case XmlPullParser.START_TAG:
				...
				}else if (parser.getName().equals("chy_shuoming")) {
					parser.next();
					weather.chy_shuoming = parser.getText();
				}
				break;
